...
**Repo:** `https://github.com/YOUR-USERNAME/fleet-tracker`
...
**Next.js 16** (App Router) · **TypeScript** (strict) · **tRPC** · **Prisma** + **PostgreSQL** · **NextAuth (Auth.js v5)** · **Pusher** (WebSockets) · **Leaflet** · **Zod** · **Vitest** · **Tailwind CSS**
